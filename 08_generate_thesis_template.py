...
def main():
    ...
    body(doc, "1. 核心發現一：用水密集度（Water_Intensity）在「高耗水／高污染產業當期（t-0）」對成本黏性呈顯著加劇效果。"
              ...
              "從而顯著加劇費用調整之非對稱性，使其成本黏性顯著大於用水密集度低之企業。此結果顯著支持本研究之核心假說 H6！")
    body(doc, "2. 核心發現二：廢棄物密集度（Waste_Intensity）在「高耗水／高污染產業遞延一期（t-1）」對成本黏性呈顯著加劇效果。"
              ...
              "且因廢棄物清理合約多採年度簽訂或長期約束，相關處置支出之向下調整阻力在營收下滑後第一年（t-1）最為顯著，展現具體的法遵與合約僵固性（支持假說 H3 與 H6）。")
