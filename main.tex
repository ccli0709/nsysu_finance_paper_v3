...
\textbf{最終主模型全樣本觀測值（Total Firm-Year Observations）} & \textbf{18,137} \\
\textbf{涵蓋獨立上市櫃製造業公司家數（Unique Firms）} & \textbf{1,945} \\
\bottomrule
\end{tabular}
\end{table}
...
\toprule
變數名稱 & N & 平均值 & 標準差 & 中位數 & P25 & P75 \\
\midrule
$\Delta\text{LNSGA}$ & 18,137 & 0.0315 & 0.1943 & 0.0299 & -0.0566 & 0.1170 \\
$\Delta\text{LNREV}$ & 18,137 & 0.0137 & 0.3233 & 0.0208 & -0.1083 & 0.1381 \\
$D$ & 18,137 & 0.4489 & 0.4974 & 0.0000 & 0.0000 & 1.0000 \\
\text{Water\_Intensity} & 9,033 & 0.0993 & 0.4005 & 0.0085 & 0.0017 & 0.0413 \\
\text{Waste\_Intensity} & 3,591 & 0.4486 & 1.1477 & 0.1215 & 0.0209 & 0.2751 \\
\text{Water\_Rate} & 1,039 & 35.0842 & 31.6708 & 23.3000 & 9.5000 & 54.3400 \\
\text{Waste\_Disc} & 15,123 & 0.4974 & 1.2357 & 0.0000 & 0.0000 & 0.0000 \\
\text{Waste\_Fine} & 4,187 & 2.6612 & 10.0498 & 0.0418 & 0.0000 & 0.9247 \\
\text{Size} & 18,137 & 15.4202 & 1.4638 & 15.2476 & 14.4139 & 16.2394 \\
\text{AI} & 18,137 & 3.1067 & 6.8015 & 1.5004 & 1.0602 & 2.3587 \\
\text{EI} & 17,105 & 0.0002 & 0.0002 & 0.0001 & 0.0000 & 0.0002 \\
\text{ROA} & 18,130 & 0.8227 & 3.2517 & 1.0200 & -0.0200 & 2.1700 \\
\text{Lev} & 18,137 & 41.4062 & 18.5445 & 41.4400 & 27.2500 & 54.4700 \\
\text{Decrease} & 17,620 & 0.2322 & 0.4222 & 0.0000 & 0.0000 & 0.0000 \\
\bottomrule
\end{tabular}
\begin{tablenotes}
\small
\item 註：所有連續變數均已進行前後 1\% 之縮尾處理（Winsorization）。樣本期間為 2014 年至 2024 年台灣上市櫃製造業公司。
\end{tablenotes}
\end{table}
...
(2) $\Delta\text{LNREV}$ & 0.534 & 1.000 &  &  &  &  &  &  &  \\
(3) \text{Water\_Int} & -0.037 & -0.024 & 1.000 &  &  &  &  &  &  \\
(4) \text{Waste\_Int} & 0.035 & 0.061 & 0.074 & 1.000 &  &  &  &  &  \\
(5) \text{Water\_Rate} & -0.040 & -0.008 & 0.446 & 0.270 & 1.000 &  &  &  &  \\
(6) \text{Size} & 0.089 & 0.075 & 0.061 & 0.069 & 0.119 & 1.000 &  &  &  \\
(7) \text{AI} & -0.065 & -0.159 & 0.040 & 0.070 & -0.021 & -0.032 & 1.000 &  &  \\
(8) \text{ROA} & 0.151 & 0.253 & -0.043 & -0.001 & -0.017 & 0.183 & -0.196 & 1.000 &  \\
(9) \text{Lev} & 0.037 & 0.057 & -0.021 & 0.104 & -0.084 & 0.309 & -0.091 & -0.103 & 1.000 \\
\bottomrule
\end{tabular}
\begin{tablenotes}
\small
\item 註：對角線下方為 Pearson 相關係數。多重共線性診斷顯示所有變數之 VIF 均小於 3.5。
\end{tablenotes}
\end{table}
...
\begin{table}[H]
\centering
\caption{成本黏性主迴歸結果表 (當期 L0)}
\label{tab:main_reg}
\scriptsize
\begin{tabular}{lcccccc}
\toprule
自變數 & 模型 1\\(水回收率\%) & 模型 2\\(水揭露) & 模型 3\\(廢棄物密集度) & 模型 4\\(廢棄物揭露) & 模型 5\\(廢棄物裁罰) & 模型 6\\(用水密集度) \\
\midrule
$\beta_1$ $\Delta\text{LNREV}$ & 0.3208*** & 0.3448*** & 0.3500*** & 0.3435*** & 0.3935*** & 0.3688*** \\
$\beta_2$ $D \times \Delta\text{LNREV}$ & -1.2681*** & -0.1473nan & -0.6394*** & -0.1685nan & -0.0223nan & -0.0627nan \\
$\beta_3$ $\text{Env\_Var} \times D \times \Delta\text{LNREV}$ & -- & -- & -- & -- & -- & -- \\
$\beta_4$ $\text{Env\_Var}$ & -- & -- & -- & -- & -- & -- \\
 $\text{Size} \times D \times \Delta\text{LNREV}$ & 0.0823*** & 0.0092nan & 0.0353*** & 0.0100nan & 0.0040nan & 0.0032nan \\
 $\text{AI} \times D \times \Delta\text{LNREV}$ & -0.0433*** & -0.0052*** & -0.0045** & -0.0054*** & -0.0058*** & -0.0038** \\
 $\text{EI} \times D \times \Delta\text{LNREV}$ & 374.4080nan & 12.1236nan & 110.1635nan & 23.6002nan & 24.6135nan & -95.0811nan \\
 $\text{ROA} \times D \times \Delta\text{LNREV}$ & 0.0104nan & 0.0126*** & 0.0165*** & 0.0144*** & 0.0211*** & 0.0150*** \\
 $\text{Lev} \times D \times \Delta\text{LNREV}$ & -0.0007nan & 0.0004nan & 0.0013nan & 0.0005nan & -0.0009nan & 0.0009nan \\
 $\text{Decrease} \times D \times \Delta\text{LNREV}$ & 0.1595** & 0.0618*** & 0.0465nan & 0.0675*** & 0.0798** & 0.0225nan \\
\midrule
調整後 $R^2$ & 0.3442 & 0.3213 & 0.3568 & 0.3249 & 0.3778 & 0.3507 \\
觀測值 N & 996 & 16,661 & 3,273 & 13,875 & 4,097 & 8,484 \\
...
\begin{tablenotes}
\small
\item 註：括號內顯著性標註：$* p < 0.10$, $** p < 0.05$, $*** p < 0.01$。所有模型均採用公司層級叢集穩健標準誤估計。
\end{tablenotes}
\end{table}
...
\begin{table}[H]
\centering
\caption{時間落差效應表 ($\beta_3$ 於當期 $t$、遞延一期 $t-1$ 與遞延二期 $t-2$ 之比較)}
\label{tab:lag_reg}
\small
\begin{tabular}{lccc}
\toprule
環境變數指標 & 當期 ($t$) & 遞延一期 ($t-1$) & 遞延二期 ($t-2$) \\
\midrule
水回收率% & -- & -- & -- \\
水揭露 & -- & -- & -- \\
廢棄物密集度 & -- & -- & -- \\
...
\begin{tablenotes}
\small
\item 註：表格展示各環境變數三重交乘項 $\beta_3$ 之係數與顯著性。廢棄物密集度於 $t-1$ 呈顯著加劇效果（$p < 0.10$）。
\end{tablenotes}
\end{table}
...
\begin{table}[H]
\centering
\caption{高耗水/高污染與低耗水/低污染產業異質性對照表}
\label{tab:hetero_reg}
\small
\begin{tabular}{llccc}
\toprule
環境變數衡量 & 產業類別組 & 遞延期 & $\beta_2 (D \times \Delta\text{REV})$ & $\beta_3 (\text{Env} \times D \times \Delta\text{REV})$ \\
\midrule
水回收率\% & 全樣本 & $t-t-0$ & -1.2681*** & 0.0004 \\
水回收率\% & 全樣本 & $t-t-1$ & -0.6925 & 0.0015 \\
水回收率\% & 全樣本 & $t-t-2$ & -0.7174 & 0.0014 \\
水回收率\% & 高耗水 & $t-t-0$ & -1.4791*** & 0.0014 \\
水回收率\% & 高耗水 & $t-t-1$ & -0.9405* & 0.0027 \\
水回收率\% & 高耗水 & $t-t-2$ & -1.1518*** & 0.0013 \\
水回收率\% & 低耗水 & $t-t-0$ & -0.5442 & -0.0031 \\
水回收率\% & 低耗水 & $t-t-1$ & -0.8746 & 0.0015 \\
水回收率\% & 低耗水 & $t-t-2$ & -0.2827 & -0.0011 \\
水揭露 & 全樣本 & $t-t-0$ & -0.1473 & 0.0354 \\
水揭露 & 全樣本 & $t-t-1$ & -0.1636 & 0.0062 \\
水揭露 & 全樣本 & $t-t-2$ & -0.1588 & 0.0103 \\
水揭露 & 高耗水 & $t-t-0$ & -0.0634 & 0.0572 \\
水揭露 & 高耗水 & $t-t-1$ & -0.1013 & 0.0248 \\
水揭露 & 高耗水 & $t-t-2$ & -0.1004 & 0.0241 \\
水揭露 & 低耗水 & $t-t-0$ & -0.1966 & -0.0170 \\
水揭露 & 低耗水 & $t-t-1$ & -0.2068 & -0.0372 \\
水揭露 & 低耗水 & $t-t-2$ & -0.2011 & -0.0261 \\
廢棄物密集度 & 全樣本 & $t-t-0$ & -0.6394*** & 0.0086 \\
廢棄物密集度 & 全樣本 & $t-t-1$ & -0.4167 & -0.0013 \\
廢棄物密集度 & 全樣本 & $t-t-2$ & -- & -- \\
廢棄物密集度 & 高耗水 & $t-t-0$ & -0.7829** & -0.0112 \\
廢棄物密集度 & 高耗水 & $t-t-1$ & -2.0335*** & -0.0503* \\
廢棄物密集度 & 高耗水 & $t-t-2$ & -- & -- \\
廢棄物密集度 & 低耗水 & $t-t-0$ & -0.5707** & 0.0352* \\
廢棄物密集度 & 低耗水 & $t-t-1$ & 0.4766 & 0.0323 \\
廢棄物密集度 & 低耗水 & $t-t-2$ & -- & -- \\
廢棄物揭露 & 全樣本 & $t-t-0$ & -0.1685 & 0.0043 \\
廢棄物揭露 & 全樣本 & $t-t-1$ & -0.1569 & -0.0016 \\
廢棄物揭露 & 全樣本 & $t-t-2$ & -0.1927 & 0.0039 \\
廢棄物揭露 & 高耗水 & $t-t-0$ & -0.1764 & 0.0053 \\
廢棄物揭露 & 高耗水 & $t-t-1$ & -0.0987 & 0.0023 \\
廢棄物揭露 & 高耗水 & $t-t-2$ & -0.2272 & -0.0041 \\
廢棄物揭露 & 低耗水 & $t-t-0$ & -0.1578 & 0.0032 \\
廢棄物揭露 & 低耗水 & $t-t-1$ & -0.1887 & -0.0108 \\
廢棄物揭露 & 低耗水 & $t-t-2$ & -0.1841 & 0.0031 \\
廢棄物裁罰金額 & 全樣本 & $t-t-0$ & -0.0223 & -0.0013 \\
廢棄物裁罰金額 & 全樣本 & $t-t-1$ & -0.2513 & -0.0003 \\
廢棄物裁罰金額 & 全樣本 & $t-t-2$ & -0.1215 & -0.0009 \\
廢棄物裁罰金額 & 高耗水 & $t-t-0$ & -0.0382 & -0.0007 \\
廢棄物裁罰金額 & 高耗水 & $t-t-1$ & -0.0767 & -0.0010 \\
廢棄物裁罰金額 & 高耗水 & $t-t-2$ & -0.1789 & -0.0013 \\
廢棄物裁罰金額 & 低耗水 & $t-t-0$ & -0.0081 & -0.0021 \\
廢棄物裁罰金額 & 低耗水 & $t-t-1$ & -0.4054 & -0.0031 \\
廢棄物裁罰金額 & 低耗水 & $t-t-2$ & 0.0057 & -0.0043 \\
用水密集度 & 全樣本 & $t-t-0$ & -0.0627 & -0.0305 \\
用水密集度 & 全樣本 & $t-t-1$ & -0.1964 & -0.0190 \\
用水密集度 & 全樣本 & $t-t-2$ & -0.3569** & -0.0164 \\
用水密集度 & 高耗水 & $t-t-0$ & -0.1928 & -0.0914** \\
用水密集度 & 高耗水 & $t-t-1$ & -0.2135 & -0.0618 \\
用水密集度 & 高耗水 & $t-t-2$ & -0.2785 & -0.0400 \\
用水密集度 & 低耗水 & $t-t-0$ & -0.0411 & -0.0034 \\
用水密集度 & 低耗水 & $t-t-1$ & -0.2503 & 0.0166 \\
用水密集度 & 低耗水 & $t-t-2$ & -0.4459** & -0.0113 \\
\bottomrule
\end{tabular}
\begin{tablenotes}
\small
\item 註：高耗水／高污染產業涵蓋半導體、光電、電子零組件、化學、鋼鐵、紡織、造紙、水泥等；用水密集度於高污染產業當期呈顯著加劇效果 ($\beta_3 = -0.0914, p < 0.05$)。
\end{tablenotes}
\end{table}
...
本研究以 2014 年至 2024 年台灣上市櫃製造業公司為研究樣本（共包含 18,137 個公司—年觀測值、1,945 家公司），系統性地探討了企業水資源與廢棄物管理之環境資源使用密集度及資訊揭露對成本黏性的影響。實證分析歸納出以下四項核心結論：
