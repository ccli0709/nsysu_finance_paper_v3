...
def main():
    ...
    body(doc, "6. 連續兩年營收下降（SUCC_DEC）：虛擬變數，若公司第 t 年與第 t-1 年營收皆較前一年度下降則設定為 1，否則為 0。用以控管經理人對悲觀需求預期之修正行為。")
    ...
    body(doc, "最後，在公司特徵控制變數方面，公司規模（SIZE）平均值為 15.4202（對應資產總額對數，標準差 1.4638）；"
              ...
              "連續兩年營收下降虛擬變數（SUCC_DEC）平均值為 0.2322，顯示約 23.22% 之觀測值處於連續營收衰退狀態。"
